...
public class Response
{
	...
	{
		addHeader(HttpHeaders.Names.LOCATION.toString(), url);
	}
...
//		}
    ...
    {
		return getHeader(HttpHeaders.Names.CONTENT_TYPE.toString());
    }
	...
	public void setContentType(String contentType)
    {
		...
		{
			addHeader(HttpHeaders.Names.CONTENT_TYPE.toString(), contentType);
		}
    }
