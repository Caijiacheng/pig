...
implements Preprocessor
{
	...
	public void process(Request request)
	{
		...
		String authorization = request.getHeader(HttpHeaders.Names.AUTHORIZATION.toString());
	...
	private void throwUnauthorizedException()
    {
	    ...
	    e.setHeader(HttpHeaders.Names.WWW_AUTHENTICATE.toString(), "Basic realm=\"" + realm + "\"");
	    throw e;
    }
}
