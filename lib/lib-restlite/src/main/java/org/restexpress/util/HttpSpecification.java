...
public final class HttpSpecification
{
	...
	{
		if (response.getHeader(HttpHeaders.Names.CONTENT_LENGTH.toString()) != null)
		{
	...
	{
		if (response.getHeader(HttpHeaders.Names.CONTENT_TYPE.toString()) != null)
		{
	...
	{
		if (response.getHeader(HttpHeaders.Names.ALLOW.toString()) == null)
		{
